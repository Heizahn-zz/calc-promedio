...
let billValue = 0.0; //Valor por defecto
let tipValue = 0.15; //Valor por defecto -> 15% si el boton esta activo
let peopleValue = 1;
...
function handleClick(event){
	...
	//Limpiear la propina personalizada
	tipCustom.value = '';
